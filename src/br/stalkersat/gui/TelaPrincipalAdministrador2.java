...
public class TelaPrincipalAdministrador2 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TelaPrincipalAdministrador2 frame = new TelaPrincipalAdministrador2();
	 ...
	 * Create the frame.
	 */
	public TelaPrincipalAdministrador2() {
